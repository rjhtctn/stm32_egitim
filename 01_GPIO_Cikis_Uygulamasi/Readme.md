...
| \*\*PA5\*\* | `LD2\_Pin` | \*\*Output Push-Pull\*\* | \*\*High (1)\*\* | Kart üzerindeki Yeşil LED |
...
1\.  \*\*Sistem Saati Ayarı:\*\* İşlemci, dahili osilatör (HSI) ve PLL kullanılarak \*\*72 MHz\*\* hızında çalışacak şekilde yapılandırıldı.

2\.  \*\*GPIO Başlatma (`MX\_GPIO\_Init`):\*\*
